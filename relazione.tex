...
In questo lavoro abbiamo presentato lo scenario delle Wireless Sensor Network e affrontato le problematiche comuni ai protocolli per sistemi IoT
facendo riferimento al protocollo GREEN-WUP. Successivamente è stata proposta una nuova variante di GREEN-WUP che affronta i problemi del protocollo
originale e abbiamo valutato i risultati raggiunti ottimizando i parametri fondamentali al fine di migliorarne le prestazioni.
